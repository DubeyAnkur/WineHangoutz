	...
	public class AboutController1:UIViewController
	{
		...
		public override void ViewDidLoad()
		{
			try
			{
				...
				Heading2.Frame = new CGRect(5, 280, UIScreen.MainScreen.Bounds.Width-20, UIScreen.MainScreen.Bounds.Height);
				...
				p2.Frame = new CGRect(5, 320 , UIScreen.MainScreen.Bounds.Width-20, UIScreen.MainScreen.Bounds.Height);
				...
				Heading3.Frame = new CGRect(5, 495, UIScreen.MainScreen.Bounds.Width-20, UIScreen.MainScreen.Bounds.Height);
				...
				p3.Frame = new CGRect(5, 535, UIScreen.MainScreen.Bounds.Width-20, UIScreen.MainScreen.Bounds.Height);
				...
				p4.Frame = new CGRect(5, 815, UIScreen.MainScreen.Bounds.Width-20, UIScreen.MainScreen.Bounds.Height);
				...
				p5.Frame = new CGRect(5, 850, UIScreen.MainScreen.Bounds.Width-20, UIScreen.MainScreen.Bounds.Height);
				...
				p6.Frame = new CGRect(5, 900, UIScreen.MainScreen.Bounds.Width-20, UIScreen.MainScreen.Bounds.Height);
				...
				{
					h = scrollView.Subviews[i].Frame.Size.Height+330;
				}
